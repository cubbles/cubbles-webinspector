...
(function () {
  ...
  function updateSlotsInfoInTables (slots, table) {
    ...
    function createElementForCell (cellName, slotInfo) {
      switch (cellName) {
        case 'slotId':
          ...
          var tooltip = generateTooltipId(slotInfo);
    ...
    function generateTooltipId (slotInfo) {
      var tooltip = document.createElement('span');
      tooltip.innerHTML = ' 🛈 ';
      tooltip.classList.add('tooltip');
      var tooltipTextSpan = document.createElement('span');
      tooltipTextSpan.appendChild(generateSlotInfoP('Type', slotInfo.type));
      if (slotInfo.description) {
        tooltipTextSpan.appendChild(generateSlotInfoP('Description', slotInfo.description));
      }
