(function () {
  ...
  function inspectCubble (runtimeId) {
    let cubble = document.querySelector(`[runtime-id="${runtimeId}"]`);
    let divHighlighter = document.getElementById('divHighlighter');
    divHighlighter.classList.remove('hidden');
    divHighlighter.style.left = `${cubble.getBoundingClientRect().left}px`;
    divHighlighter.style.top = `${cubble.getBoundingClientRect().top}px`;
    divHighlighter.style.width = `${cubble.getBoundingClientRect().width}px`;
    divHighlighter.style.height = `${cubble.getBoundingClientRect().height}px`;
  }

  function deInspectCubble () {
    let divHighlighter = document.getElementById('divHighlighter');
    divHighlighter.classList.add('hidden');    
  }
