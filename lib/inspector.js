...
(function () {
  ...
  function generateSlotsTable(tableMetadata) {
    var headers = ['Slot Id <small>[type]</small>', 'Value'];
  ...
  function createSlotsInfoElementsInTables (slots, table) {
    ...
    function createElementForSlotInitValue (slotInfo) {
      var container = document.createElement('div');
      container.classList.add('slot-value-element-container');
      var label = document.createElement('label');
      label.innerText = 'Initial value:'

      var preElement = document.createElement('pre');
      preElement.classList.add('slot-init-value-element');
      setJsonToSlotValueElement(preElement, slotInfo.value, {collapsed: true, withQuotes: true});
    ...
    function createElementForSetValue (slotInfo) {
      ...
      setValueDiv.appendChild(label);

      var slotVTF = generateInputForSlotValue(slotInfo);
      slotVTF.value = JSON.stringify(slotInfo.value, null, ' ');
